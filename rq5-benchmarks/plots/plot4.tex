    ...
    \begin{tikzpicture}
      \pgfplotsset{
        every axis/.style={
          ...
          legend style={font=\small,at={(axis cs:0.05,0.45)},anchor=north west},
          legend entries={ours,
                          ours$_\bot$,
                          apinis,
                          more precise,
      ...
      \foreach \hide/\index/\a/\shift in {/0/ours/-5pt,hide axis/3/ours-bot/0pt,hide axis/6/apinis/5pt}{
        \begin{axis}[\hide]
          ...
          \addlegendimage{pattern=horizontal lines}
          ...
          \addplot table [y=worse-\a, x expr=\coordindex] {\tabledifferences};
          \addplot table [y=better-\a, x expr=\coordindex] {\tabledifferences};
